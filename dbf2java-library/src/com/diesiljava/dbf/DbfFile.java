...
public class DbfFile {
    ...
    static final int BUFFER_SIZE = 1024 * 6;
    static final int TYPE_FOXBASE = 0x02;
    static final Logger logger = Logger.getLogger(DbfFile.class.getName());
    private int type = TYPE_FOXBASE;
    ...
    public DbfFile(File file, Field[] fields) throws FileNotFoundException {
        this(file, fields, TYPE_FOXBASE);
    }

    public DbfFile(String fileName, Field[] fields) throws FileNotFoundException {
        this(fileName, fields, TYPE_FOXBASE);
    }

    public DbfFile(File file, Field[] fields, int type) throws FileNotFoundException {
        this(file);
        setFields(fields);
        setType(type);
        createFile();
    ...
    public DbfFile(String fileName, Field[] fields, int type) throws FileNotFoundException {
        this(fileName);
        setFields(fields);
        setType(type);
        createFile();
    ...
    public void createFile() {
        ...
        data[2] = (byte) calendar.get(Calendar.MONTH);
